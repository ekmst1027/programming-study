...
def drawBoard(board):
    ...
    for i in range(15):
        if i < 10:
            ...
            extraSpace = ' '
        print('{}{} {} {}'.format(extraSpace, i, getRow(board, i), i))
        print()
        print('    ' + ('0123456789' * 6))
        print(hline)
...
def makeMove(board, chests, x, y):
    ...
    if smallestDistance == 0:
        ...
        if smallestDistance < 10:
            ...
            return '''Treasure detected at a distance of {} from the sonar
             device'''.format(smallestDistance)
        else:
            board[x][y] = 'O'
...
def showInstructions():
    ...
    is to find the three sunken treasure chests that are lurking in the part of the ocean
    you are in and collect them.

    To play, enter the coordinates of the point in the ocean you wish to drop a
    sonar device, the d below marks where the device was dropped, and the 2's
    represent distances of 2 away from the device. The 4's represent distances of
    4 away from the device
...
while True:
    ...
    if sonarDevices == 0:
        print("We've run out pf sonar devices! Now we have to turn the ship around and head")
